import pandas as pd
import ta
from src.data_sourcing import Data_Sourcing
...
class Technical_Calculations(Data_Sourcing):
    ...
    def TA_lib_all(self):
        return ta.add_all_ta_features(self.df.copy(), open="Open", high="High", low="Low", close="Adj Close", volume="Volume", fillna=True)
...
class Indications(Technical_Calculations):
    ...
    def __init__(self,
        ...
        # super(Indications, self).initial_indications()
